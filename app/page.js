  ...
  return (
    <div className="px-5 pb-6 my-7 w-full bg-white">
      <div className="flex justify-between items-center w-full py-6">
        ...
        <div>
          <button className="text-white text-xs flex items-center justify-center rounded-xl py-1 px-2 bg-[#1570EF]"><PlusCircleIcon class="h-6 w-6 text-white" /> Ajouter une voiture</button>
        </div>
      </div>
