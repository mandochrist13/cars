...
export default function ajouts(){

    return (
        <>
        <div className="bg-white rounded-md flex justify-center items-center flex-col ">
        <div className="mt-6">
            <h1 className="text-2xl text-blue-500 font-bold">Ajouter une voiture</h1>
        </div>
        ...
        <button className="bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600 transition-colors duration-300">Ajouter</button>
        </div>
        </>
    );
};